...
process.on('message', (message) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const statusCode = yield (0, run_1.run)(process.cwd(), process.env.NX_WORKSPACE_ROOT, message.targetDescription, message.overrides, message.isVerbose, message.taskGraph);
