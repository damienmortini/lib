...
export default class MarkerTracker {
  constructor(drawable) {
    ...
    const width = this.drawable.width || this.drawable.videoWidth;
    const height = this.drawable.height || this.drawable.videoHeight;
  ...
  applyMarkerMatrix(matrix4) {
    ...
    const detected = this._detector.detectMarkerLite(this._raster, 170);
    if (detected) {
