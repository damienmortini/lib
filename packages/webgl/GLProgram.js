...
export class GLProgram {
  ...
  constructor({ gl, uniforms = {}, vertex = GLSLShader.VERTEX, fragment = GLSLShader.FRAGMENT, transformFeedbackVaryings = undefined }) {
    this.gl = gl;
    ...
    class Attributes extends Map {
      set(
        ...
        {
          buffer = undefined,
          location = self.#attributesLocations.get(name),
          size = 1,
