...
export default class Pointer extends Vector2 {
  ...
  _updatePositions() {
    ...
    this.centered.x = this.centeredFlippedY.x = this.x - this._domElementBoundingRect.width * 0.5;
    this.centered.y = this.centeredFlippedY.y = this.y - this._domElementBoundingRect.height * 0.5;
