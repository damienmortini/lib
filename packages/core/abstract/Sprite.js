export default class Sprite {
  ...
  set frame(value) {
    ...
    this.offsetX = -(this.sourceWidth - frameData.frame.w) * 0.5 + frameData.spriteSourceSize.x + this.sourceWidth * (0.5 - frameData.pivot.x);
    this.offsetY = -(this.sourceHeight - frameData.frame.h) * 0.5 + frameData.spriteSourceSize.y + this.sourceHeight * (0.5 - frameData.pivot.y);
  }
