...
var P = class extends B {
  ...
  setArray(t4) {
    return this.I = t4
      ...
      : P.ComponentType.FLOAT, this.M = t4, this;
  }
  ...
  if (o5 !== F2.NONE) {
    ...
    switch (o5) {
      case F2.EXPONENTIAL:
        ...
        break;
      case F2.OCTAHEDRAL:
        a5.byteStride = i3 > 8 ? 8 : 4, a5.componentType = i3 > 8 ? O2 : w2, a5.normalized = true, s5 = e4.getElementSize() === 3
          ? (function (e5) {
          ...
          : s5, a5.array = t4.encodeFilterOct(s5, e4.getCount(), a5.byteStride, i3);
        break;
      case F2.QUATERNION:
